...
* [Peer to Peer Networking](https://github.com/akhil2015/florincore-p2p)
...
```javascript
var privateKey = new florincore.PrivateKey();

var exported = privateKey.toWIF();
// e.g. L3T1s1TYP9oyhHpXgkyLoJFGniEgkv2Jhi138d7R2yJ9F4QdDU2m
var imported = florincore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new florincore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new florincore.URI(paymentInfo).toString();
```
