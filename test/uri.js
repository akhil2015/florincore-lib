...
describe('URI', function() {
  ...
  it('should support double slash scheme', function() {
    var uri = new URI('florincoin://LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.address.toString().should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
  });

  it('should input/output String', function() {
    var str = 'florincoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?' +
  ...
  it('should input/output JSON', function() {
    var json = JSON.stringify({
      address: 'LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3',
      message: 'Donation for project abc',
      label: 'myLabel',
      other: 'xD'
    });
  ...
  it('should support numeric amounts', function() {
    var uri = new URI('florincoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=12.10001');
  ...
  it('should support extra arguments', function() {
    ...
    uri.message.should.equal('Donation for project abc');
  ...
  it('should generate a valid URI', function() {
    new URI({
      ...
      'florincoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3'
    );
    ...
    new URI({
      ...
      'florincoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.10001&message=Hello%20World&something=else'
    );

  });

  it('should be case insensitive to protocol', function() {
    var uri1 = new URI('FlOrincOin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    var uri2 = new URI('florincoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');

    uri1.address.toString().should.equal(uri2.address.toString());
  });

  it('writes correctly the "r" parameter on string serialization', function() {
    var originalString = 'florincoin:mmrqEBJxUCf42vdb3oozZtyz5mKr3Vb2Em?amount=0.1&' +
  ...
  it('displays nicely on the console (#inspect)', function() {
    var uri = 'florincoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3';
